...
[![Build Status](http://jenkins.openpreservation.org/buildStatus/icon?job=veraPDF-model-rel)](http://jenkins.openpreservation.org/job/veraPDF-model-rel/ "OPF Jenkins Release")
