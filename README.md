...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.23/job/model/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.23/job/model/ "OPF Jenkins")
