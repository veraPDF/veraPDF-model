...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.24rc/job/model/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.24rc/job/model/ "OPF Jenkins")
