...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/model/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.26rc/job/model/ "OPF Jenkins")
